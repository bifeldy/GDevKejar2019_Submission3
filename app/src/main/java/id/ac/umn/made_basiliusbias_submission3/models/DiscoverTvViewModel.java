...
public class DiscoverTvViewModel extends ViewModel {
    private MutableLiveData<List<Tv>> listDiscoverTV = new MutableLiveData<>();

    public void loadDiscoverTV(View v, ImageView loadingImage, TextView loadingText, String sort_by, int year) {
        ...
        // API
        DiscoverAPI discoverTVAPI = new DiscoverAPI();
        ...
        response -> {
            try {
                ...
                discoverTVAPI.createDiscoverTV(jsonObject);
                ...
                // Add Data & Show
                listDiscoverTV.postValue(discoverTVAPI.getDiscoverTV().getResults());
