package id.ac.umn.made_basiliusbias_submission3.apis;

import android.content.Context;
import id.ac.umn.made_basiliusbias_submission3.R;
import id.ac.umn.made_basiliusbias_submission3.pojos.DiscoverMovie;
import id.ac.umn.made_basiliusbias_submission3.pojos.DiscoverTv;
import id.ac.umn.made_basiliusbias_submission3.pojos.Movie;
import id.ac.umn.made_basiliusbias_submission3.pojos.Tv;
...
public class DiscoverAPI {
    ...
    public void setDiscoverTV(DiscoverTv discoverTV) {
        this.discoverTV = discoverTV;
    }
    ...
    public void createDiscoverMovie(JSONObject response) {
        ...
        try {
            ...
            if(movies != null) discoverMovie.setResults(movies);
        }
        catch (JSONException e) {
    ...
    public void createDiscoverTV(JSONObject response) {
        ...
        try {
            ...
            if(tvs != null) discoverTV.setResults(tvs);
        }
        catch (JSONException e) {
